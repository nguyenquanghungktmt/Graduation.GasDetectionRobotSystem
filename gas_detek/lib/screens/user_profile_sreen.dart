...
class _UserProfileState extends State<UserProfile> {
  ...
  Widget build(BuildContext context) {
    ...
    // load avatar
    Widget avatarImg = Image.network('https://www.w3schools.com/howto/img_avatar.png');

    // try {
    //   avatarImg = Image.network(avatarUrl);
    // } on NetworkImageLoadException catch (exception) {
    //   avatarImg = Icon(Icons.person, color: Colors.grey.shade300);
    // } catch (error) {
    //   avatarImg = Icon(Icons.person, color: Colors.grey.shade300);
    // }
              ...
              child: Container(
                ...
                child: ClipOval(
                  child: SizedBox.fromSize(
                    ...
                    child: FittedBox(child: avatarImg, fit: BoxFit.fill),
                  ),
                ),
              )
            ),
