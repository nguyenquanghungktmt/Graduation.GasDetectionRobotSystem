...
final client = MqttServerClient('gas-detekt-iot-hub.azure-devices.net', '');
...
Future<int> main() async {
  ...
  context
      .setTrustedCertificates('../assets/DigiCertAssuredIDRootG2.crt.pem');
  ...
  final connMess = MqttConnectMessage()
      .withClientIdentifier('RB23GD1708')
