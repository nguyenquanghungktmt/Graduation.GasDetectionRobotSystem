...
class Alert {
        ...
        return AlertDialog(
          ...
          actions: [
            TextButton(
              ...
              child: Text(textNo, style: TextStyle(fontSize: 16, color: Colors.red[900]),),
            ),
            TextButton(
              onPressed: () => Navigator.pop(context, true),
              child: Text(textYes, style: TextStyle(fontSize: 16, color: Colors.green[900])),
            ),
          ],
        );
      },
  ...
  static Future<void> dialogNotification(
    BuildContext context,
    String title,
    String content, {
    String textButton = 'Okieeeeeee'
  }) async {
    return await showDialog(
      context: context,
      builder: (context) {
  ...
  static void closeToast({Duration? durationBeforeClose, Function? actionAfterClose}) {
    Future.delayed(durationBeforeClose ?? const Duration(seconds: 2), () {
